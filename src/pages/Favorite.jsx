  ...
  if(load){
    return (
      <div className='flex flex-col w-full h-[100vh] bg-orange-400 justify-center items-center'>
        <p className="text-6xl font-bold text-slate-800 font-serif text-center">PARS BİLİŞİM</p>
        ...
        <div>
          ...
          <div className="flex flex-wrap mb-4 justify-center items-center gap-5">
            {favorList.map((item, index) => (
              <div className="bg-orange-400 flex flex-col justify-center items-center w-[350px] h-[400px] border-2 border-slate-400 mt-10 relative shadow-md shadow-slate-400 rounded-md mx-auto" key={index}>
